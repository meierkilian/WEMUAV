% Parameters
outGifFilename = ".\src\UtilsScript\plots\squareFlight_short.gif";
outImgFilename = "C:\Users\Kilian\Documents\EPFL\PDM\Reporting\MasterThesisReport\figures\tiltFrame.eps";
...
for idx = timeRange
    ...
    if outType == "Img"
        exportgraphics(gcf, outImgFilename);
    elseif outType == "Gif"
