...
% Generating parameters relevant for preprocessing
    ...
    para.startTime = datetime(2021,04,20,09,30,00); 
    % para.startTime = datetime(2021,04,20,09,39,00); 
    % para.startTime = ""; 

    % datetime of end time, if "" (empty string) then end is set at the last data point.
    para.endTime = datetime(2021,04,20,09,34,00); 
    % para.endTime = datetime(2021,04,20,09,41,00); 
    % para.endTime = ""; 
