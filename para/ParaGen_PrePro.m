...
% Generating parameters relevant for preprocessing
    ...
    % flightInputpath
    para.refInput.path = {...
        char(fullfile("S:","ProjectMaster","2021_KilianMeier","Vufflens20213103","WeatherStation","data_127.txt")) ...
    %     ,''
        };
    ...
    para.refInput.type = 'topoaws';

    % path to flight data, can be a vector of paths, must match size of
    % refInputpath
    para.flightInput.path = {...
        char(fullfile("S:","ProjectMaster","2021_KilianMeier","Vufflens20213103","Mission6 - weatherStation","FLY130.csv")) ...
    ...
    % topoaws data header 
    para.topoaws.header = {'TOW','AirTemp1','AirHumidity','AtmPressure','WindSpeed','WindDir','UnkownVar1','Lati','Long','Alti','GPSNbrSat','GPSLockFlag','UnkownVar2','UnkownVar3','UnkownVar4','UnkownVar5'};
