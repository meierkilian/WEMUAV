...
% Generating parameters relevant for preprocessing
    ...
    % flightInputpath
    para.refInput.path = {...
        char(fullfile("C:","Users","Kilian","Documents","EPFL","PDM","SW","EstArthurGarreau","1_DATA","Anemo","2020.06.03 23.59 Adventdalen_Sec.dat")) ...
    %     ,''
        };
    ...
    para.flightInput.path = {...
        char(fullfile("C:","Users","Kilian","Documents","EPFL","PDM","SW","EstArthurGarreau","1_DATA","Phantom","2020-06-03_FLY113.csv")) ...
